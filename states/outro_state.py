...
class OutroState(BaseState):
    ...
    def __init__(self, engine):
        ...
        print("OutroState: Reproduciendo video de Outro...")
    ...
    def _go_to_next_state(self):
        """Limpia recursos y cambia al estado de juego completado."""
        print("OutroState: Finalizando Outro.")
        self.video.stop()
